    ...
    public static function content(): array
    {
        return [
            ...
            'sections' => [
                ...
                ['key' => 'instagram', 'title' => "O clube na estrada:\nregistros & momentos", 'body' => "Acompanhe nossos passeios, viagens e a rotina do motoclube no Instagram.\nMarque @motoclube nas suas fotos de estrada.", 'image_path' => null, 'cta_label' => 'Seguir no Instagram', 'cta_url' => 'https://instagram.com', 'enabled' => true, 'position' => 3],
                ['key' => 'contact', 'title' => "O próximo encontro\ncomeça com uma conversa.", 'body' => 'Quer conhecer melhor o motoclube? Procure os membros e a diretoria para saber mais sobre os encontros, os passeios e como se aproximar da nossa comunidade.', 'image_path' => null, 'cta_label' => null, 'cta_url' => null, 'enabled' => true, 'position' => 4],
            ],
        ];
    }
}
